...
<!--    start item stock details-->

    <div id="responsive-itemstock" class="modal fade"   role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Available Item Data</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
                <div class="modal-body">
                    <div class="itemdatamdl"></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="row page-titles">
	<div class="col-md-5 align-self-center">
		<h4 class="text-themecolor">Sales Order Bill</h4>
	</div>
	<div class="col-md-7 align-self-center text-right">
		<div class="d-flex justify-content-end align-items-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
				<li class="breadcrumb-item active">Sales Order Bill</li>
			</ol>
		</div>
	</div>
</div>
	...
	<div class="card" style="width: 100%;">
		<div class="card-body p-b-0">
			...
			<ul class="nav nav-tabs customtab2" role="tablist">
				<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Sales Order Bill</span></a> </li>
						            ...
						            <tbody>
						            	...
						            	<tr id="">
							               <td class="editdelaction">
						                        <a href="<?=base_url();?>Sales_controller/FinishPurchaseOrderBill?finishpurchaseorderid=<?=$value->Finish_Purchase_Id;?>" ><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
						                        <a onclick="deletedata('<?=$value->Finish_Purchase_Id;?>','finishpurchaseorderdelete');"><i class="fa fa-trash-o"></i></a>
						                        <a href="<?=base_url();?>Sales_controller/PrintSalesOrderBill?salesbillid=<?=$value->Finish_Purchase_Id;?>" ><i class="fa fa-print"></i></a>&nbsp;&nbsp;
						                    </td>
							               <td><?=$value->Type;?></td>
							               <td><?=$value->Voucher;?></td>
							               <td><?=$value->Ord_Ref;?></td>
					...
					<form action="" method="post" name="addfinishpurchasefrm" id="addfinishpurchasefrm" novalidate>
						...
						<div class="row common_master_form_div">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
										...
										<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
											<div class="row">
                                                ...
                                                <div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
                                                    <div class="form-group field">
                                                        <div class="">
                                                            <input type="text" id="ord_ref"  name="ord_ref" placeholder="ORD/REF" class="form-control findbilldatabyordref"  onfocusout="findsalebilldata();findsalesmiddlecontent();salebilltotalpcscal();" >
                                                        </div>
                                                    </div>
                                                </div>
												...
												<div class="col-12 col-sm-8 col-md-10 col-lg-4 col-xl-10">
													<div class="form-group field">
														<div class="controls">
															...
															<option selected="" value="Sales Order Bill">Sales Order Bill</option>
												...
												<?php
												$finishcount = $this->db->query("SELECT Voucher from finish_purchase where Type = 'Sales Order Bill' order by Finish_Purchase_Id desc")->row_array();
												...
												<div class="col-12 col-sm-8 col-md-10 col-lg-4 col-xl-10">
													<div class="form-group field">
														<div class="">
															<input type="text"  name="Voucher_NO" id="Voucher_NO" placeholder="Voucher NO NO."value="<?=$Voucher;?>" class="form-control voucharno"  >
														</div>
													</div>
												</div>

												<!-- onfocusout="findbilldata();findonlymiddlecontent();totalpcscal();" -->
												...
												<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
														<div class="form-group field">
														<div class="">
															<input type="text" id="Bill_NO"   name="Bill_NO" placeholder="Enter Bill No." class="form-control">
														</div>
													</div>
												</div>
												<!-- <div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
								...
								<div class="row">
									...
									<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
										...
										<div class="">
											...
											<input type="text"  name="totaloldpcs" id="totaloldpcs" class="form-control">
									...
									<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 d-flex ">
										<div class="form-group">
											<label>Total Bill Order PCS:</label>
										</div>
									</div>
									<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
										<div class="form-group field">
										<div class="">
											...
											<input type="text"  id="afternewtotal" class="form-control">
									...
									<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
										...
										<div class="">
											...
											<input type="text"  name="remainingtotal" id="remainingtotal" class="form-control">
								...
								<!-- <h4>Total Order PCS : </h4>

								<input type="text" placeholder="hello" name="totaloldpcs" id="totaloldpcs">
									<input type="text" name="afternewtotal" id="afternewtotal">
									<input type="text" name="remainingtotal" id="remainingtotal"> -->

								<div class="setresponse" style="overflow-x: scroll;overflow-y: scroll;">
								</div>
									...
									<div class="row removemargin">
										<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
											...
											<div class="row">
												...
												<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 d-flex">
													<div class="form-group">
														<label>Freight Discount (+/-):</label>
													</div>
												</div>
												<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
													<div class="form-group field">
														<div class="">
															<input type="text"  name="freight_discount" id="freight_discount" onfocusout="changebillval();" placeholder="Enter Discount AMT" class="form-control" value="0"> 
														</div>
													</div>
												</div>
					...
					<form  class="" id="editfinishpurchasefrm" method="POST" name="" novalidate>
						...
						<div class="row common_master_form_div">
							<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
										...
										<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
											<div class="row">
												...
												<div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
														<div class="form-group field">
														<div class="">
															<input type="text" id="Bill_NO"   name="Bill_NO" placeholder="Enter Bill No." value="<?=$editpurchaseOrderBilldata['Bill_No'];?>" class="form-control">
														</div>
													</div>
												</div>
								...
								{
									?>
									<table id="finshprinttbl" class="table order-list table-responsive">
										<thead>
										<tr>
											<td>Pick Item</td>
											<td></td>
											...
											<tr>
												...
												<td style="padding: 0.2rem !important;">
													<input type="text" onfocusout="finishpurchase('<?= $m; ?>');" name="pcs<?= $m; ?>"
														   id="pcs<?= $m; ?>" class=" finalpcs<?= $m; ?> form-control pcsclassedit pcs<?= $m; ?> " placeholder="Pcs"
												...
												<td style="padding: 0.2rem !important;">
													<input type="text" name="amount<?= $m; ?>" id="amount<?= $m; ?>"
														   class="form-control finaleditamt<?= $m; ?> editamount editamount<?= $m; ?> amount<?= $m; ?>"
														   placeholder="Amount" value="<?= $purchase_details->Amount; ?>"/>
												</td>

                                                <td style="padding: 0.2rem !important;">
<!--                                                    <div class="storestock"></div>-->

                                                <?php
                                                //$Finish_Purchase_Id = $editpurchaseOrderBilldata['Finish_Purchase_Id'];
                                                ...
                                                $vno = $editpurchaseOrderBilldata['Voucher'];
                                                $itemid = $purchase_details->Item_Id;
                                                $stock_details = $this->db->query("SELECT * from stock_details where Item_Id = '$itemid'")->result();
                                                ?>

                                                    <!--        <form class="" id="addpurchasestock" method="POST" name="" novalidate>-->
                                                    ...
                                                    <table id="additemstock" class="table additemstock edititemstock table-responsive" style="width: 100%;">
                                                        ...
                                                        foreach ($stock_details as $stock_detailsval)
                                                        {
                                                            ...
                                                            <tr id="additemtr<?=$y;?>" class="additemtr<?=$y;?>">
                                                                ...
                                                                <?php
                                                                $forstock = $this->db->query("SELECT * from stock_maintain where Vouchar_No = '$vno' AND Item_Id ='$itemid' AND Size_Number_Id = '$stock_detailsval->Size_Number_Id' AND Size_Character_Id = '$stock_detailsval->Size_Character_Id' AND Color_Id ='$stock_detailsval->Color_Id'")->row_array();
                                                                ?>

                                                                <td style="padding: 0.2rem !important;">
                                                                    <input  type="text" onkeyup="forstockcalculation('<?=$itemid;?>','<?=$y;?>');" onfocusout="totalpurcal('<?=$itemid;?>','<?=$y;?>','<?= $m; ?>');"  name="purchasestock<?=$itemid;?>[]" id="purchasestock<?=$itemid;?><?=$y;?>" class="form-control totalpurcal purchasestock<?=$itemid;?>" placeholder="Quantity" value="<?=$forstock['Purchase_Stock'];?>" />
                                                                </td>
										...
										<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
											...
											<div class="row">
												...
												<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
													<div class="form-group field">
														<div class="">
															<input type="text"  name="freight_discount" id="freight_discount" onfocusout="changebillval();" placeholder="Enter Discount AMT" class="form-control" value="<?=$editpurchaseOrderBilldata['Freight_Discount'];?>"> 
														</div>
													</div>
												</div>
...
// function getstockdetails(count)
// {
//     $('#sizenumber0').attr("style", "pointer-events: none;");
//
//     var itemid = $("#itemdetails"+count).val();
//     var vno = $("#Voucher_NO").val();
//     $("#responsive-itemstock").modal('show');
//
//     $.ajax({
//         url: base_url+'Stock/Stock_controller/getstockdetails',
//         data: {itemid:itemid,vno:vno},
//         type: 'POST',
//         success: function(data){
//             $(".itemdatamdl").html(data);
//             setTimeout(function(){ $("#purchasestock0").focus(); }, 3000);
//
//         }
//     });
// }
...
function getstockdetails(count)
{
    ...
    $.ajax({
        url: base_url+'Stock/Stock_controller/getstockdetails',
        data: {itemid:itemid,vno:vno,count:count},
        type: 'POST',
        success: function(data){
            $(".storestock"+count).html(data);
        }
    });
}

function addpurchasestock() {

    var form = $('#addpurchasestock')[0]; // You need to use standard javascript object here
    var formData = new FormData(form);

    $.ajax({
        url: base_url+'Stock/Stock_controller/addpurchasestock',
        data: formData,
        type: 'POST',
...
$( "body" ).delegate( ".fordisable", "keydown", function(e) {
    if(e.keyCode == 32)
    {
         return false;
    }
...
function forstockcalculation(itemid,counter)
{
    var mainstock = $("#stock"+itemid+counter).val();
    var purchasestock = $("#purchasestock"+itemid+counter).val();

    if(parseInt(mainstock) < parseInt(purchasestock))
    {
        $.toast({
            heading: 'Warning'
        ...
        $("#purchasestock"+itemid+counter).val(0);
        return false;
    }
}
</script>