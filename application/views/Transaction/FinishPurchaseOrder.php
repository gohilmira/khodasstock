	...
	<div class="container-fluid">
																...
																<div class="form-group">
																	<div class="">
																		<select name="mainscreen" id="mainscreen" class=" form-control">
																			...
																			{
																				?>
																				<option value="<?=$screenvalue->screenBrandID;?>"><?=$screenvalue->brandName;?></option>
																				<?php
																			}
																			?>
																		</select>
		...
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">Finish Purchase Order</h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
						<li class="breadcrumb-item active">Finish Purchase Order</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="card" style="width: 100%;">
				<div class="card-body p-b-0">
					...
					<ul class="nav nav-tabs customtab2" role="tablist">
						<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Finish Purchase Order</span></a> </li>
								            ...
								            <tbody>
								            	...
								            	<tr id="">
									               <td class="editdelaction">
								                        <a href="<?=base_url();?>Transaction_controller/FinishPurchaseOrder?finishpurchaseorderid=<?=$value->Finish_Purchase_Id;?>" ><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
								                        <a onclick="deletedata('<?=$value->Finish_Purchase_Id;?>','finishpurchaseorderdelete');"><i class="fa fa-trash-o"></i></a>
								                        <a href="<?=base_url();?>Transaction_controller/PrintFinishPurchase?printFinishPurchaseOrder=<?=$value->Finish_Purchase_Id;?>" ><i class="fa fa-print"></i></a>&nbsp;&nbsp;
								                    </td>
									               <td><?=$value->Type;?></td>
									               <td><?=$value->Voucher;?></td>
									               <td><?=$value->Ord_Ref;?></td>
											...
											<div class="row removemargin">
												<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
													<div class="row">
														...
														<div class="col-12 col-sm-8 col-md-10 col-lg-4 col-xl-10">
															<div class="form-group field">
																<div class="controls">
																	...
																	<option selected="" value="Finish Purchase">Finish Purchase </option>
														...
														<?php
														$finishcount = $this->db->query("SELECT Voucher from finish_purchase where Type = 'Finish Purchase' order by Finish_Purchase_Id desc")->row_array();
													...
													<div class="row">
														...
														<!-- <div class="col-12 col-sm-2 col-md-2 col-lg-3 col-xl-2">
															...
															<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
																...
																<option value="">-Select-</option>
																<?php
																foreach ($getscreendata1 as $value)
																{
																?>
										    ...
										    <tbody>
										    	...
										    	foreach ($collection as $purchase_details)
										    	{
										            ...
										            <td style="padding: 0.2rem !important;">
										             ...
										             <td style="padding: 0.2rem !important;">
										                <input type="text" onfocusout="finishpurchase('<?=$m;?>');" name="Pcs<?=$m;?>" id="Pcs<?=$m;?>"  class="form-control pcsclassedit finalpcs<?=$m;?> Pcs<?=$m;?>" placeholder="Pcs" value="<?=$purchase_details->Pcs;?>"/>
										            </td>
										            <td style="padding: 0.2rem !important;">
										            ...
										            <td style="padding: 0.2rem !important;">
										                <input type="text" name="amount<?=$m;?>" id="amount<?=$m;?>" class="form-control finaleditamt<?= $m; ?> editamount editamount<?=$m;?> amount<?=$m;?>" placeholder="Amount" value="<?=$purchase_details->Amount;?>"/>
										            </td>
											...
											<div class="row removemargin">
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													...
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 forhideshowigst">
														<div class="form-group field">
															<div class="">
																<input type="text"  name="igst_persantage" id="igst_persantage" placeholder="IGST %" class="form-control greypurbillcalculate igst_persantage" value="<?=$editpurchaseOrderBilldata['Igst']?>"> 
															</div>
														</div>
													</div>
													...
													<div class="col-12 col-sm-1 col-md-1 col-lg-1 col-xl-1 d-flex">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="igstamt" id="igstamt" placeholder="IGST AMT." class="form-control greypurbillcalculate igstamt" value="<?=$editpurchaseOrderBilldata['Igst_Amt']?>"> 
																</div>
															</div>
														</div>
