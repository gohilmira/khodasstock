											...
											<div class="row removemargin">
												<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
													<div class="row">
														...
														<?php
														$finishcount = $this->db->query("SELECT Voucher from finish_purchase where Type = 'Finish Purchase Bill' order by Finish_Purchase_Id desc")->row_array();
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group field">
																<div class="">
																	<input type="text" id="ord_ref" onfocusout="findbilldata();findonlymiddlecontent();totalpcscal();"  name="ord_ref" placeholder="ORD/REF" class="form-control findbilldatabyordref">
																</div>
															</div>
														</div>
