...
<html>
	<head>
		<title>FINISH PURCHASE BILL</title>
	</head>
	<body>
		<div>
		...
		<!-- 	<div style="text-align: center;">
			...
			<table style="width: 100%;" class="table table-boarder">
				<tbody>
					...
					<td style="text-align: right;">BILL NO. : <?=$PrintFinishPurchase['Bill_No'];?></td>
				</tbody>
			</table>
			</div>
			...
			<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						...
						<td style="text-align: right;">ORDER NO:<?=$PrintFinishPurchase['Ord_Ref'];?></td>
						</tbody>						
				</table>
			</div>
		...
		<!-- 	<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						...
						<td style="text-align: right;">GSTIN:<?=$PrintFinishPurchase['HasteGstIn'];?></td>
						</tbody>						
				</table>
			</div> -->
			...
			<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						<td style="text-align: left;">AGENT:<?=$brockerdata['LName'];?></td>
						<td style="">PHONES:<?=$brockerdata['LMobile'];?></td>
			...
			<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						<td style="text-align: left;">ADDRESS:<?=$brockerdata['LAddress'] ." ".$brockerdata['LAddressLine2'];?></td>
			...
			<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						<td style="text-align: left;">L.R. NO. :<?=$PrintFinishPurchase['Lr_No'];?></td>
						<td style="">LR DATE:<?=$PrintFinishPurchase['Lr_Date'];?></td>
						<td style="text-align: right;">WEIGHT:<?=$PrintFinishPurchase['Weight'];?></td>
			...
			<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						<td style="text-align: left;">TRANSPORT:<?=$PrintFinishPurchase['TransportName'];?></td>
						<td style="">CASE NO :<?=$PrintFinishPurchase['Case_No'];?></td>
						<td style="text-align: right;">FREIGHT:<?=$PrintFinishPurchase['Height'];?></td>
			...
			<div>
				<table style="width: 100%;" class="table table-boarder">
					<tbody>
						<td style="text-align: left;">STATION:<?=$PrintFinishPurchase['StationName'];?></td>
						<td style="">HSN/SAC :5407</td>
						<td style="text-align: right;">jhgjghj</td>
			...
			<div>
				<table style="width: 100%;border-style: dashed;border-width: 0 0 2px 0;" class="table table-boarder">
					<tbody>
						<td style="text-align: left;">Distance(km):<?=$PrintFinishPurchase['LDistance'];?></td>
						<td style="">Transporter ID :<?=$PrintFinishPurchase['TransportName'];?></td>
						<td style="text-align: right;">E-Way Bill no :<?=$PrintFinishPurchase['E_Way_Bill_No'];?></td>
	...
	<!-- 		<div style="border-style: dashed;border-width: 0 0 2px 0;">
			...
			<table style="width: 100%;border-style: dashed;border-width: 0 0 2px 0;">
