								...
								<form  name="frm_broker_list" method="post" action="<?php echo base_url();?>Broker_controller/index">
									...
									<div class="table-responsive">
								        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
								            ...
								            <tbody>
								            	<?php
								            	foreach ($salesorderdata as $value)
								            	{
								            	?>
								            	<tr id="">
									               <td class="editdelaction">
								                        <a href="<?=base_url();?>Sales_controller/SalesOrder?salesorderid=<?=$value->Finish_Purchase_Id;?>" ><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
								                        <a onclick="deletedata('<?=$value->Finish_Purchase_Id;?>','finishpurchaseorderdelete');"><i class="fa fa-trash-o"></i></a>
								                        <a href="<?=base_url();?>Sales_controller/PrintSalesOrder?salesid=<?=$value->Finish_Purchase_Id;?>" ><i class="fa fa-print"></i></a>&nbsp;&nbsp;
								                    </td>
									               <td><?=$value->Type;?></td>
									               <td><?=$value->Voucher;?></td>
									               <td><?=$value->Ord_Ref;?></td>
												...
												<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
													<div class="row">
														...
														<div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
															<div class="form-group field">
																<div class="controls">
																	<select name="CompanyId" id="CompanyId" style="width: 100%; height:36px;"  class="select2 form-control custom-select customvalidation">
																		<option value=""> --Select -- </option>
																		<?php
														...
														<?php
														$finishcount = $this->db->query("SELECT Voucher from finish_purchase Where Type = 'Sales Order' order by Finish_Purchase_Id desc")->row_array();
														...
														<div class="col-12 col-sm-8 col-md-10 col-lg-4 col-xl-10">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="Voucher_NO" id="Voucher_NO" placeholder="Voucher NO." value="<?=$Voucher;?>" class="form-control">
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
															<div class="form-group field">
																<div class="controls">
																	<select name="PartyAcID" id="PartyAcID" style="width: 100%; height:36px;" class="select2 form-control custom-select customvalidation" onchange="getpartytoother(this);">
																	<option value=""> --Select -- </option>
																	<?php
														...
														<div class="col-12 col-sm-8 col-md-8 col-lg-8 col-xl-8">
															<div class="form-group field">
																<div class="">
																	<select name="Transport" id="Transport"  style="width: 100%; height:36px;" class="select2 form-control custom-select TransportIDData">
																		<option value=""> --Select -- </option>
																			<?php
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group field">
																<div class="">
																	<input type="text" id="ord_ref"  name="ord_ref" placeholder="ORD/REF" class="form-control"> 
																</div>
															</div>
														</div>
...
<!-- 
											...
											<div class="row removemargin">
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													...
													<div class="col-12 col-sm-1 col-md-1 col-lg-1 col-xl-1 d-flex">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 forhideshowgst">
															<div class="form-group field forhideshowgst">
																<div class="">
						...
						<div class="tab-pane  p-20" id="editform" role="tabpanel">
							<form  class="" id="editfinishpurchasefrm" method="POST" name="" novalidate>
								...
								<input type="hidden" value="<?=$editsalesorderdata['Finish_Purchase_Id'];?>" id="finishpurchaseorderid" name="finishpurchaseorderid">
									...
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
												...
												<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
													<div class="row">
															...
															<div class="form-group">
																<div class="">
																	<select name="CompanyId" id="CompanyId"  style="width: 100%; height:36px;" class="select2 form-control custom-select forcmp">
																		...
																		{
																			?>
																			<option <?php if($qgetCompanyDataedit->CompanyID == $editsalesorderdata['Comapny_Id']){echo "selected";}?> value="<?=$qgetCompanyDataedit->CompanyID;?>"> <?=$qgetCompanyDataedit->CompanyName?> </option>
																			<?php
																		}
																		?>
														...
														<div class="col-12 col-sm-8 col-md-10 col-lg-4 col-xl-10">
															<div class="form-group">
																<div class="">
																	<input type="text"  name="Voucher_NO" id="Voucher_NO" placeholder="Voucher NO NO." class="form-control" value="<?=$editsalesorderdata['Voucher'];?>">
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="LR_No" id="LR_No" placeholder="LR No." class="form-control" value="<?=$editsalesorderdata['Lr_No_Awb'];?>">
																</div>
															</div>
														</div>
															...
															<div class="form-group">
																<div class="">
																	<select name="PartyAcID" id="PartyAcID" style="width: 100%; height:36px;" class="select2 form-control custom-select customvalidation PartyAcID prtsv" onchange="getpartytootheredit(this);">
																		...
																		{
																			?>
																			<option <?php if($editsalesorderdata['Party_Id'] == $qgetpartyacData->Ledger_Id){echo "selected";}?> value="<?=$qgetpartyacData->Ledger_Id		?>"> <?=$qgetpartyacData->LName?> </option>
																			<?php
																		}
																		?>
																	</select>
															...
															<div class="form-group">
																<div class="">
																	<select name="StateID" id="StateID"  style="width: 100%; height:36px;" class="select2 form-control custom-select stateidcls EditStateID" onchange="editstatetodata(this);">
																		...
																		{
																			?>
																			<option <?php if($editsalesorderdata['State_Id'] == $qgetstateData->stateID){echo "selected";}?> value="<?=$qgetstateData->stateID?>"> <?=$qgetstateData->stateName." (".$qgetstateData->StateCode.")" ?> </option>
																			<?php
																		}
																		?>
															...
															<div class="form-group">
																<div class="">
																	<select name="Transport" id="Transport"   style="width: 100%; height:36px;" class="select2 form-control custom-select Transportcls TransportID">
																		...
																		{
																			?>
																			<option <?php if($editsalesorderdata['Transport_Id'] == $value->transportID){echo "selected";}?> value="<?=$value->transportID;?>"><?=$value->transportName;?></option>
																			<?php
																		}
																		?>
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group">
																<div class="">
																	<input type="text" id="ord_ref"  name="ord_ref" placeholder="ORD/REF" class="form-control" value="<?=$editsalesorderdata['Ord_Ref']?>"> 
																</div>
															</div>
														</div>
															...
															<div class="form-group">
																<div class="">
																	<select name="Bill_NO" id="Bill_NO"  style="width: 100%; height:36px;" class="select2 form-control custom-select GreyPOrderNo EditGreyPOrderNo">
																		...
																		{
																			?>
																			<option <?php if($editsalesorderdata['Bill_No'] == $qgetordernoData->GreyOrderNo){echo "selected";}?> value="<?=$qgetordernoData->GreyOrderNo;?>"> <?=$qgetordernoData->GreyOrderNo?> </option>
																			<?php
																		}
																		?>
																	</select>
												...
												<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
													<div class="row">
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group">
																<div class="">
																	<input type="text" id=""  name="FinishPurchaseBillOrderDate" placeholder="DATE" class="form-control datepicker-autoclose" value="<?=$editsalesorderdata['Lr_Date']?>"> 
																</div>
															</div>
														</div>
															...
															<div class="form-group">
																...
																<select name="GstType" id="GstType"  style="width: 100%; height:36px;"  onchange ="editchangegsttype();" class="select2 form-control custom-select GstType">
																	...
																	<?php
																		...
																		{
																			?>
																			<option <?php if($editsalesorderdata['Gst_Type_Id'] == $value->GsttypeID){echo "selected";}?> value="<?=$value->GsttypeID;?>"><?=$value->GstTypeName;?></option>
																			<?php
																		}
																		?>
																</select>
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group">
																<div class="">
																	...
																	{
																		?>
																		<option <?php if($editsalesorderdata['Haste_Id'] == $value->HasteID){echo "selected";}?> value="<?=$value->HasteID;?>"><?=$value->HasteName;?></option>
																		<?php
																	}
																	?>
																	</select>
														...
														<div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
															<div class="form-group">
																<div class="">
																	...
																	{
																		?>
																		<option <?php if($editsalesorderdata['Brocker_Id'] == $qgetbrokerData->Ledger_Id){echo 'selected';}?> value="<?=$qgetbrokerData->Ledger_Id?>"> <?=$qgetbrokerData->LName?> </option>
																			<?php
																		}
																		?>
																	</select>
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group">
																<div class="">
																	<input type="text" id="Dhara"  name="Dhara" placeholder="Dhara" class="form-control" value="<?=$editsalesorderdata['Dhara']?>"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group">
																<div class="">
																	<input type="text" id="Grace"  name="Grace" placeholder="Grace" class="form-control" value="<?=$editsalesorderdata['Grace']?>"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
															<div class="form-group">
																<div class="controls">
																	...
																	{
																		?>
																		<option <?php if($editsalesorderdata['Station_Id'] == $value->StationID){echo "selected";}?> value="<?=$value->StationID;?>">
																			<?= $value->StationName;?>
																		</option>
																		<?php
																	}
														...
														<!-- <div class="col-12 col-sm-2 col-md-2 col-lg-3 col-xl-2">
															...
															<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
																<div class="form-group">
																	...
																	<select name="ScreenSeries" id="ScreenSeries"   style="width: 100%; height:36px;" class="select2 form-control custom-select">
																		...
																		{
																			?>
																			<option <?php if($editsalesorderdata['Screen_Series']== $value->ScreenRegisterID){echo 'selected';}?> value="<?=$value->ScreenRegisterID;?>"><?=$value->ItemDCut;?></option>
																			<?php
																		}
																		?>
																	</select>
															...
															<div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-10">
																<div class="form-group">
																	...
																	<input type="text" id="Party_GSTIN"  name="Party_GSTIN" placeholder="Party Gstin" class="form-control EditPartyGstin" value="<?=$editsalesorderdata['Party_Gstin']?>">
																</div>
															</div>
													</div>
												</div>
										...
										<table id="finshprinttbl" class="table order-list">
										    ...
										    <tbody>
										    	...
										    	<?php
										    	$Finish_Purchase_Id = $editsalesorderdata['Finish_Purchase_Id'];
										    	$collection = $this->db->query("SELECT * from finish_purchase_details where Finish_Purchase_Id = '$Finish_Purchase_Id'")->result();
										    	$m = 0;
										    	foreach ($collection as $purchase_details)
										    	{
										    		...
										    		<tr>
										            <td style="padding: 0.2rem !important;">
										            	<select name="itemdetails<?=$m;?>" onchange="getitemdata(<?=$m;?>);" id="itemdetails<?=$m;?>" class="form-control itemdetails<?=$m;?>">
									            		<?php
									            		foreach ($getitemdetailsdata as $value)
									            		{
								            				?>
								            				<option <?php if($purchase_details->Item_Id == $value->ItemdetailID){echo "selected";}?> value="<?=$value->ItemdetailID;?>"><?=$value->IName;?></option>
								            				<?php
									            		}
									            		?>
										            	</select>
										            ...
										            <td style="padding: 0.2rem !important;">
										                <input type="text" onclick="setcounterhd(<?=$m;?>);" name="bundles<?=$m;?>" onfocusout="bundlecal1(<?=$m;?>);" id="bundles<?=$m;?>"  class="form-control bundles<?=$m;?>" placeholder="Bundles" value="<?=$purchase_details->Bundles?>"/>
										            </td>
										            <td style="padding: 0.2rem !important;">
										                <select name="category<?=$m;?>" id="category<?=$m;?>" class="form-control category<?=$m;?>">
														<?php
														foreach ($getCategoryData as $value)
														{
															?>
															<option <?php if($purchase_details->Category_Id==$value->CategoryID){echo "selected";}?> value="<?=$value->CategoryID;?>"><?=$value->CategoryName;?></option>
															<?php
														}
														?>
										            	</select>
										            ...
										            <td style="padding: 0.2rem !important;">
														...
														{
															?>
															<option <?php if($purchase_details->Packing_Id == $value->PackingID){echo "selected";}?> value="<?=$value->PackingID;?>"><?=$value->PackingName;?></option>
															<?php
														}
														?>
										            	</select>
										            ...
										            <td style="padding: 0.2rem !important;">
										                <select name="unit<?=$m;?>" id="unit<?=$m;?>" class="form-control editunit<?=$m;?> unit<?=$m;?>"  onchange="changecalculation(<?=$m;?>)">

														    <option <?php if($purchase_details->Unit == 'pcs'){echo "selected";}?> value="pcs">Pcs</option>
														    <option <?php if($purchase_details->Unit == 'mts'){echo "selected";}?> value="mts">MTS</option>
														    <option <?php if($purchase_details->Unit == 'kg'){echo "selected";}?> value="kg">KG</option>
														    <option <?php if($purchase_details->Unit == 'suit'){echo "selected";}?> value="suit">Suit</option>
														    <option <?php if($purchase_details->Unit == 'other'){echo "selected";}?> value="other">Other</option>
										                </select>
										            </td>
										             <td style="padding: 0.2rem !important;">
										                <input type="text" onfocusout="finishpurchase('<?=$m;?>');" name="Pcs<?=$m;?>" id="Pcs<?=$m;?>"  class="form-control pcsclassedit Pcs<?=$m;?>" placeholder="Pcs" value="<?=$purchase_details->Pcs;?>"/>
										            </td>
										            <td style="padding: 0.2rem !important;">
										                <input type="text" onfocusout="finishpurchase('<?=$m;?>');" name="Cut<?=$m;?>" id="Cut<?=$m;?>"  class="form-control Cutter<?=$m;?> Cut<?=$m;?>" placeholder="Cut" value="<?=$purchase_details->Cut;?>" value=""/>
										            </td>
										            <td style="padding: 0.2rem !important;">
										                <input type="text" name="mts<?=$m;?>" id="mts<?=$m;?>"  class="form-control editmtscls mts<?=$m;?>" placeholder="Mts" value="<?=$purchase_details->Mts_Qty;?>"/>
										            </td>
										            <td style="padding: 0.2rem !important;">
										                <input type="text" name="Rate<?=$m;?>"  onfocusout="finishpurchase('<?=$m;?>');" id="Rate<?=$m;?>" class="form-control editRate<?=$m;?> Rate<?=$m;?>" placeholder="Rate" value="<?=$purchase_details->Rate;?>" />
										            </td>
										            <td style="padding: 0.2rem !important;">
										                <input type="text" name="amount<?=$m;?>" id="amount<?=$m;?>" class="form-control editamount editamount<?=$m;?> amount<?=$m;?>" placeholder="Amount" value="<?=$purchase_details->Amount;?>"/>
										            </td>
													...
													<div class="row">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															...
															<div class="">
																...
																<input type="text" value="<?=$editsalesorderdata['Total_Pcs']?>"  name="totalpcs" id="totalpcs" placeholder="Enter Total Pcs" class="form-control totalpcs">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																...
																<input type="text" value="<?=$editsalesorderdata['Total_Mts']?>"  name="totalmts" id="totalmts" placeholder="Enter Total MTS" class="form-control edittotalmts">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																...
																<input type="text" value="<?=$editsalesorderdata['Grand_Total']?>" name="grandtotal" id="grandtotal" placeholder="Enter Grand Total" class="form-control editgrandtotal">
												...
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													<div class="row">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	...
																	<input type="text" id="Obtained_By"  name="Obtained_By" placeholder="Packet By" class="form-control" value="<?=$editsalesorderdata['Obtain_By']?>"> 
																</div>
															</div>
														</div>
															...
															<div class="form-group field">
																<div class="">
																	<select name="RMK" id="RMK"   style="width: 100%; height:36px;" class="select2 form-control custom-select">
																		...
																		{
																			?>
																		<option <?php if($editsalesorderdata['Remark_Id'] ==$value->RemarkID){echo "selected";}?> value="<?=$value->RemarkID;?>"><?=$value->Remark;?></option>
																		<?php
																		}
																		?>
																	</select>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Only_X']?>" type="text"  name="only_x" id="only_x" placeholder="Enter X." class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div> -->
														<div class="col-12 col-sm-1 col-md-1 col-lg-1 col-xl-1 d-flex ">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['E_Way_Bill_No']?>" type="text"  name="E_Way_Bill_No" id="E_Way_Bill_No" placeholder="E-Way Bill No" class="form-control greypurbillcalculate">
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3"  style="display: none;">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Net_Amt']?>" type="text"  name="Net_Amt" id="Net_Amt" placeholder="Net Amt" class="form-control greypurbillcalculate">
																</div>
															</div>
														</div> -->
													</div>
												...
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													<div class="row">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Lr_No']?>" type="text"  name="lr_no" id="lr_no" placeholder="LR No." class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Lr_Date']?>" type="text"  name="lr_date" id="lr_date" placeholder="LR Date" class="form-control greypurbillcalculate datepicker-autoclose"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Lr_Rec_Date']?>" type="text"  name="lr_rec_date" id="lr_rec_date" placeholder="LR Rec Date" class="form-control greypurbillcalculate datepicker-autoclose"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Weight']?>" type="text"  name="weight" id="weight" placeholder="Weight" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input  value="<?=$editsalesorderdata['Height']?>" type="text"  name="height" id="height" placeholder="Height" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
													</div>
												...
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													<div class="row">
															...
															<div class="form-group field">
																<div class="">
																	...
																	<?php
																		...
																		{
																			?>
																		<option <?php if($editsalesorderdata['Remark1'] == $value->RemarkID){echo "selected";}?> value="<?=$value->RemarkID;?>"><?=$value->Remark;?></option>
																		<?php
																		}
																		?>
																	</select>
														...
														<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="grandtotal1" id="grandtotal1" placeholder="Enter Grand Total" value="<?=$editsalesorderdata['Grand_Total1']?>" class="form-control editgrandtotal1"> 
																</div>
															</div>
														</div>%
														...
														<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="discountless1" id="discountless1" placeholder="Enter Discount Less"  value="<?=$editsalesorderdata['Discount_Less1']?>" class="form-control discountless1"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="amountless" id="amountless" value="<?=$editsalesorderdata['Amount_Less']?>" placeholder="Enter Amount Less" class="form-control amountless"> 
																</div>
															</div>
														</div>
													...
													<div class="row">
															...
															<div class="form-group field">
																<div class="">
																	...
																	<?php
																		...
																		{
																			?>
																		<option <?php if($editsalesorderdata['Remark2'] == $value->RemarkID){echo 'selected';}?>  value="<?=$value->RemarkID;?>"><?=$value->Remark;?></option>
																		<?php
																		}
																		?>
																	</select>
														...
														<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="grandtota2" id="grandtota2" placeholder="Enter Grand Total" class="form-control editgrandtota2" value="<?=$editsalesorderdata['Grand_Total2']?>"> 
																</div>
															</div>
														</div> -
														...
														<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="discountless2" id="discountless2" placeholder="Enter Discount Less" class="form-control discountless2" value="<?=$editsalesorderdata['Discount_Less2']?>"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-2 col-md-2 col-lg-2 col-xl-2">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="amountless2" id="amountless2" placeholder="Enter Amount Less" value="<?=$editsalesorderdata['Amount_Less2']?>" class="form-control amountless2"> 
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="net_amt" id="net_amt" placeholder="Bill Amount" class="form-control net_amt" value="<?=$editsalesorderdata['Net_Amt']?>"> 
																</div>
															</div>
														</div>
													</div>
											...
											<div class="row removemargin">
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													...
													<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 forhideshowigst">
														<div class="form-group field">
															<div class="">
																<input type="text"  name="igst_persantage" id="igst_persantage" placeholder="IGST %" class="form-control greypurbillcalculate igst_persantage" value="<?=$editsalesorderdata['Igst']?>"> 
															</div>
														</div>
													</div>
													...
													<div class="col-12 col-sm-1 col-md-1 col-lg-1 col-xl-1 d-flex">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input type="text"  name="igstamt" id="igstamt" placeholder="IGST AMT." class="form-control greypurbillcalculate igstamt" value="<?=$editsalesorderdata['Igst_Amt']?>"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Cgst']?>" type="text"  name="cgst_persantage" id="cgst_persantage" placeholder="CGST %" class="form-control cgst_persantage greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input  value="<?=$editsalesorderdata['Cgst_Amt']?>" type="text"  name="amt" id="amt" placeholder="AMT." class="form-control greypurbillcalculate amt"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Sgst']?>"  type="text"  name="sgst_persantage" id="sgst_persantage" placeholder="SGST %" class="form-control sgst_persantage greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input type="text"  value="<?=$editsalesorderdata['Sgst_Amt']?>"  name="sgdt_amt" id="sgdt_amt" placeholder="SGST AMT" class="form-control sgdt_amt"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input  value="<?=$editsalesorderdata['Taxable_Value']?>" type="text"  name="Taxable_Value" id="Taxable_Value" placeholder="Taxable Value" class="form-control greypurbillcalculate Taxable_Value"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Bill_Amt']?>" type="text"  name="Bill_Amount" id="Bill_Amount" placeholder="Net Amount" class="form-control greypurbillcalculate Bill_Amount"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Net_After_Tds']?>"  type="text"  name="Net_After_Tds" id="Net_After_Tds" placeholder="Net After Tds" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
												...
												<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
													<div class="row">
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Paid_Date']?>" type="text"  name="Paid_Date" id="Paid_Date" placeholder="Paid Date" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Discount']?>" type="text"  name="discount" id="discount" placeholder="Discount" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Pack_Folt']?>" type="text"  name="Pack" id="Pack" placeholder="Pack/Folt" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Rd']?>" type="text"  name="rd" id="rd" placeholder="R.D." class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Sweets']?>"  type="text"  name="sweets" id="sweets" placeholder="Sweets" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Oth_Bc']?>" type="text"  name="Oth_Bc" id="Oth_Bc" placeholder="Oth/Bc" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input  value="<?=$editsalesorderdata['Add_Amt']?>" type="text"  name="add_amt" id="add_amt" placeholder="Add Amt" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input  value="<?=$editsalesorderdata['Tds_Amt']?>" type="text"  name="tds_amt" id="tds_amt" placeholder="Tds Amt" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Gr']?>"  type="text"  name="gr" id="gr" placeholder="G.R." class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Paid_Amt']?>" type="text"  name="paid_amount" id="paid_amount" placeholder="Paid Amount" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
														...
														<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3">
															<div class="form-group field">
																<div class="">
																	<input value="<?=$editsalesorderdata['Bill_Amt']?>"  type="text"  name="Bill_Amount" id="Bill_Amount" placeholder="Bill Amount" class="form-control greypurbillcalculate"> 
																</div>
															</div>
														</div>
