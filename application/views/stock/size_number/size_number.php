	...
	<div class="container-fluid">
		<div class="row page-titles">
			<div class="col-md-5 align-self-center">
				<h4 class="text-themecolor">Size Number</h4>
			</div>
			<div class="col-md-7 align-self-center text-right">
				<div class="d-flex justify-content-end align-items-center">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">Size Number</li>
					</ol>
				</div>
			</div>
		</div>
			...
			<div class="card" style="width: 100%;">
				<div class="card-body p-b-0">
					...
					<ul class="nav nav-tabs customtab2" role="tablist">
						<li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">Size Number List</span></a> </li>
					...
					<div class="tab-content">
								...
								<div class="table-responsive">
									<table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										<tbody>
											<?php
											$i=1;
											foreach ($sizenumberdata as $value)
											{
											?>
											<tr>
												<td class="editdelaction">
													<a href="<?=base_url()?>Stock/Size_Number_controller?Size_Number_Id=<?=$value->Size_Number_Id;?>" ><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
													
													<a href="javascript:deletedata('<?=$value->Size_Number_Id?>','sizenumberdelete');"><i class="fa fa-trash-o"></i></a>
												</td>
												<td><?=$i++;?></td>
												<td><?=$value->Size_Number_Name;?></td>
											</tr>
											<?php
											}
											?>
						...
						<div class="tab-pane  p-20" id="profile7" role="tabpanel">
							<form  class="" id="addsizenumberform" method="POST" name="" novalidate>
								<?php
								if(empty($editsizenumberdata))
								{
									?>
										<input type="hidden" value="" id="Size_Number_Id" name="Size_Number_Id">
									<?php
								}
								?>
										...
										<div class="row">
											<div class="form-group">
												<div class="text-xs-right" style="margin-left: 8px;">
		                                            ...
		                                            <a  href="<?php echo base_url()?>Stock/Size_Number_controller" class="btn btn-info">Cancel</a>
												</div>
											</div>
										</div>
									</div>	
						...
						<div class="tab-pane  p-20" id="editform" role="tabpanel">
							<form  class="" id="editsizenumberform" method="POST" name="" novalidate>
								<input type="hidden" value="<?=$editsizenumberdata['Size_Number_Id']?>" id="Size_Number_Id" name="Size_Number_Id">
								<div class="row common_master_form_div">
									<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
										<div class="formtitle">
											<div class="row removemargin">
												<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
													<div class="row">
														...
														<div class="col-12 col-sm-8 col-md-3 col-lg-10 col-xl-3">
															<div class="form-group field">
																<div class="controls">
																	<input type="text" name="sizenumber" id="sizenumber" value="<?=$editsizenumberdata['Size_Number_Name']?>" class="form-control customvalidation" placeholder="Enter Size" required data-validation-required-message="This field is required"> 
																</div>
															</div>
														</div>
													</div>
...
<script>
	...
	$("#addsizenumberform").find(".customvalidation").jqBootstrapValidation(
    {
        preventSubmit: true,
        ...
        submitSuccess: function($form, event) {
            event.preventDefault();
                ...
                $.ajax({
                url: base_url+'Stock/Size_Number_controller/addsizenumberform',
                data: new FormData($('#addsizenumberform')[0]),
                processData: false,
                contentType: false,
                type: 'POST',
