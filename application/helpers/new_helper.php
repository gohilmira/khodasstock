							...
							<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
								<div class="row">
									...
									<div class="col-12 col-sm-8 col-md-3 col-lg-3 col-xl-3">
										<div class="form-group">
											<div class="">
												<input type="text" name="TakaAvgwt" id="TakaAvgwt" class="form-control" value="<?=$avgwt;?>" readonly=""> 
											</div>
										</div>
									</div>
						...
						?>
						    ...
						    <tbody id="tbodyid">
								...
								if(sizeof($check) > 0)
								{
									...
									{
										$TotalTakaMfgMts+=$value->TakaMfgMts;
										$TotalTakaSarees+= intval($value->TakaSarees);
										$TotalTakaFormMfsc+= $value->TakaFormMfsc;
										$TotalTakaIdealWt+= $value->TakaIdealWt;
										$TotalTakaActCut+= $value->TakaActCut;
										$TotalTakaWtLs+= $value->TakaWtLs ;
										?>
										<tr id="totalData<?=$x;?>">
						           	 	<td style="padding: 0.2rem !important;">
							           ...
							           <td style="padding: 0.2rem !important;">
							                <input type="text" name="TakaIdealWt[]" id="TakaIdealWt<?=$x;?>"  class="form-control TakaIdealWtCalSum TakaIdealWtCal<?=$x;?>" placeholder="Ideal wt" value="<?=$value->TakaIdealWt;?>"  onkeyup="TakaIdealWtCal1('<?=$x;?>');" />
							            </td>
							            <td style="padding: 0.2rem !important;">
								...
								else
								{
									...
									<tr id="totalData0">
										...
										<td style="padding: 0.2rem !important;">
							                <input type="text" name="TakaIdealWt[]" id="TakaIdealWt0"  class=" form-control TakaIdealWtCalSum TakaIdealWtCal0" placeholder="Ideal wt" onkeyup ="TakaIdealWtCal1(0);" value="" />
							            </td>
							            <td style="padding: 0.2rem !important;">
